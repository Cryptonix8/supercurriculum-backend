-- CreateEnum
DO $$ BEGIN
  CREATE TYPE "XpReason" AS ENUM ('EXERCISE_COMPLETED', 'TASK_COMPLETED', 'CORRECT_FINAL_ANSWER', 'HINT_BASED_COMPLETION', 'TUTOR_CHECK_CORRECT', 'MISTAKE_CORRECTED_AFTER_FEEDBACK', 'DAILY_STREAK_BONUS', 'FINAL_ANSWER_ONLY_PENALTY', 'SPAM_WITHOUT_COMPLETION_PENALTY');
EXCEPTION
