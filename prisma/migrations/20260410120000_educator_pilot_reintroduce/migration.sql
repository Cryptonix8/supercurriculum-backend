...
DO $$ BEGIN
  ...
  ADD CONSTRAINT "class_invites_classId_fkey"
...
DO $$ BEGIN
  ALTER TABLE "educator_audit_logs"
  ADD CONSTRAINT "educator_audit_logs_educatorId_fkey"
...
DO $$ BEGIN
  ALTER TABLE "educator_audit_logs"
  ADD CONSTRAINT "educator_audit_logs_studentId_fkey"
...
DO $$ BEGIN
  ALTER TABLE "educator_audit_logs"
  ADD CONSTRAINT "educator_audit_logs_classId_fkey"
  FOREIGN KEY ("classId") REFERENCES "classes"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;
